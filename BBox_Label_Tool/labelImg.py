...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def set_format(self, save_format):
        ...
        # elif save_format == FORMAT_CUSTOM:
        #     self.actions.save_format.setText(FORMAT_CUSTOM)
        #     self.actions.save_format.setIcon(newIcon("format_custom"))
        #     self.usingPascalVocFormat = False
        #     self.usingYoloFormat = False
        #     self.usingCustomFormat = True
        #     LabelFile.suffix = TXT_EXT

    def change_format(self):
        if self.usingPascalVocFormat: self.set_format(FORMAT_YOLO)
        elif self.usingYoloFormat: self.set_format(FORMAT_PASCALVOC)
        #elif self.usingCustomFormat: self.set_format(FORMAT_CUSTOM)
    ...
    # def loadCustomTXTByFilename(self, txtPath):
    #     if self.filePath is None:
    #         return
    #     if os.path.isfile(txtPath) is False:
    #         return

    #     self.set_format(FORMAT_CUSTOM)
    #     tYoloParseReader = YoloReader(txtPath, self.image)
    #     shapes = tYoloParseReader.getShapes()
    #     print (shapes)
    #     self.loadLabels(shapes)
